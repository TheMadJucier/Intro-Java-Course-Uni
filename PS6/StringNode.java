...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        //StringNode keanu = str;
        //Candy
       
        StringNode twixRight = null;
        StringNode twixLeft = null;
        while(str != null){
            StringNode newNode = new StringNode(str.ch, null);
            if(twixRight == null){
                twixRight = newNode;
                twixLeft = newNode;
            }
            else{
                twixRight.next = newNode;
            }
            str = str.next;twixRight = newNode;
        }
        return twixLeft;
                                         ...
                                         char afterChar) 
    {
        ...
        StringNode juniorMints = str;
        StringNode johnWick = null;
        //boolean jelly = false;
        ...
        if (juniorMints == null) { //base case
            return newNode;
        } 
        
        
        insertAfter(juniorMints.next, newChar, afterChar);
        if(juniorMints.ch == afterChar && juniorMints.next != null && juniorMints.next.ch != juniorMints.ch){ //
            
            newNode.next = juniorMints.next;
            juniorMints.next = newNode;
            return str;

        } 
        
        // if(juniorMints.next == null && juniorMints.ch != afterChar){ // couldn't find afterchar
        //     newNode.next = juniorMints.next;
        //     juniorMints.next = newNode;

        //  }
        
        johnWick = juniorMints; //trailing
        juniorMints = juniorMints.next; //incrementing
        //johnWick.next = newNode;
    ...
    public static boolean isPrefix(StringNode prefix, StringNode str) {
        ...
        StringNode current = str;
        StringNode voltage = prefix;

        
        while(current != null && voltage.next != null){
            if(current.ch == voltage.ch){
                //System.out.println("current.next.ch: " + current.next.ch);
                //System.out.println("voltage.next.ch: " + voltage.next.ch);
                //System.out.println("current.ch: " + current.ch );
                //System.out.println("voltage.ch: " + voltage.ch);
                current = current.next;
    ...
    public static StringNode removeAllSpaces(StringNode str) {
        ...
        return firstNode; //modified StringNode 
     ...
     */
    public static void toUpperCase(StringNode str) {   // recursive     
        if (str == null) {
            return;
        } else {
            toUpperCase(str.next);
           // System.out.println("str.ch: " + str.ch);
            //System.out.println("Character.toUpperCase(str.ch): " + Character.toUpperCase(str.ch));
    ...
    public static void main(String[] args) {
        ...
        // toUpperCase
        StringNode str = StringNode.convert("bruhMoment");
